<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="TechnologyBrowsers.aspx.cs" Inherits="analytcs_TechnologyBrowsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="row-fluid">
        <div class="col-md-12">
            <uc1:ctrlDataGrid ID="ctrlTopBrowsers" Title="Browsers" TableName="Browsers" TableColumnNames="Browser,Total,Percent" runat="server" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSPlaceHolder" runat="Server">
    ...
    <script type='text/javascript' src='js/FGSTechnologyBrowsers.js'></script>
</asp:Content>
