<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="TechnologyOSDetail.aspx.cs" Inherits="analytcs_TechnologyOSDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="row-fluid">
        <div class="col-md-12">
            <uc1:ctrlDataGrid ID="ctrlTopTechOS" Title="OS Detail" TableName="OS" TableColumnNames="OS,Visitors,Percent" runat="server" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSPlaceHolder" runat="Server">
    ...
    <script type='text/javascript' src='js/FGSTechnologyOSDetail.js'></script>
</asp:Content>
