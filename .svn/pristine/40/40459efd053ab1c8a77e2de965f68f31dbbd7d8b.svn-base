<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="TechnologyDevices.aspx.cs" Inherits="analytcs_TechnologyDevices" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <ul class="breadcrumb" id="BreadCrumb">
        ...
        <li>Devices <span class="divider"></span></li>
    </ul>
    ...
    <div class="row-fluid">
        <div class="col-md-12">
            <uc1:ctrlDataGrid ID="ctrlTopDevices" Title="Devices" TableName="Device" TableColumnNames="Device,Total,Percent" runat="server" />
            <uc3:ctrlPager ID="ctrlPager" PagerName="DevicePager" runat="server" />
        </div>
        <!--/span-->
    </div>
    <!--/row-->
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSPlaceHolder" runat="Server">
    ...
    <script type='text/javascript' src='js/FGSTechnologyDevices.js'></script>
</asp:Content>
