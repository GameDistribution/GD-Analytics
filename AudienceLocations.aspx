<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="AudienceLocations.aspx.cs" Inherits="analytcs_AudienceLocations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="row-fluid">
        <div class="col-md-4">
            ...
            <uc3:ctrlPager ID="ctrlPager" PagerName="CountryPager" runat="server" />
        </div>
        <!--/span-->
        <div class="col-md-8">
            <div class="thumbnail">
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSPlaceHolder" runat="Server">
    ...
    <script type='text/javascript' src='js/FGSAudienceLocations.js'></script>
</asp:Content>
