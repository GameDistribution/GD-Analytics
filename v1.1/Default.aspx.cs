...
public partial class _Default : System.Web.UI.Page
{
    ...
    */
	...
	#
    */
    public static void visit(int visitTimes, int visitState)
    {
        int UserId = checkUserExists();
        if (visitTimes < 10)
        {
            if ((Utils._POST("gid").Length == 32) && UserId > 0)
            {
                ...
                LookupService ls = new LookupService("D:/Hosts/s1.submityourgame.com/geo/GeoIPCity.dat", LookupService.GEOIP_STANDARD);
