<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="TechnologyBrowserDetail.aspx.cs" Inherits="analytcs_TechnologyBrowserDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <ul class="breadcrumb" id="BreadCrumb">
        ...
        <li>Browsers <span class="divider"></span></li>
    </ul>
    ...
    <div class="row-fluid">
        <div class="col-md-12">
            <uc1:ctrlDataGrid ID="ctrlTopTechBrowser" Title="Browser Detail" TableName="Browser" TableColumnNames="Browser,Visitors,Percent" runat="server" />
            <uc3:ctrlPager ID="ctrlPager" PagerName="BrowserPager" runat="server" />
        </div>
        <!--/span-->
    </div>
    <!--/row-->
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSPlaceHolder" runat="Server">
    ...
    <script type='text/javascript' src='js/FGSTechnologyBrowserDetail.js'></script>
</asp:Content>
