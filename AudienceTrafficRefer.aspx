<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="AudienceTrafficRefer.aspx.cs" Inherits="analytcs_AudienceTrafficRefer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="row-fluid">
        <div class="col-md-12">
            ...
            <uc3:ctrlPager ID="ctrlPager" PagerName="WebReferPager" runat="server" />
        </div>
        <!--/span-->
    </div>
    <!--/row-->
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSPlaceHolder" runat="Server">
    ...
    <script type='text/javascript' src='js/FGSAudienceTrafficRefer.js'></script>
</asp:Content>
